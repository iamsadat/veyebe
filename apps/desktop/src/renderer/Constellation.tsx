...
// ponytail: adaptive DPR based on device to avoid over-rendering high-DPI devices
...
const Node = memo(({ feature, selected, still, architecture, onSelect }: { feature: Feature; selected: boolean; still: boolean; architecture: boolean; onSelect: () => void }) => {
